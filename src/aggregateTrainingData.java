...
public class aggregateTrainingData {
	 ...
	 * @author Mats
	 */
public static String reduceDataset (int sampleRate, int numberOfSeconds, Long start, Long end, String activity) throws Exception {
